...
export default function Quizs(){
    return <div className="w-full h-fit p-2 flex justify-center items-start pl-20 flex-col">
        <p className="my-2 text-3xl font-medium">Quiz</p>
        <div className="grid grid-cols-4 gap-5">
                ...
                <AdminQuizCard imgurl="https://www.cardio.com/wp-content/uploads/2023/10/human-heart-illustration.webp" title="CardioQuiz: Heart Health Essentials"></AdminQuizCard>
        </div>
    </div>
}